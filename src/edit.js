...
const
    ...
    createDigit = (x, baseId) => {
        ...
        return [
            ...
            svg.text(Object.assign({id: `inc${baseId}`, x: x, y: -0.8}, textProperties), "⏶"),
            svg.text(Object.assign({id: `dig${baseId}`, x: x, y: -0.52}, textProperties), ""),
            svg.text(Object.assign({id: `dec${baseId}`, x: x, y: -0.26}, textProperties), "⏷")
        ];
    },
